...
from persistencia.base_de_datos import BaseDeDatos
...
class Controlador():
    ...
    def __init__(self):
        ...
        # Obtengo el objeto que me permite anadir/modificar la base de datos
        self._base_datos = BaseDeDatos.get_unica_instancia()
        

        # Para saber cuantas simulaciones hay hechas, tengo que verlo en la bbdd
        self._numReduccionesBD = self._base_datos.get_tabla_simulador().get_numSimulaciones_enBD()
    ...
    # Función que devulve el objeto base de datos
    def get_base_datos(self):
        return self._base_datos
    
    # Funcion que devuelve el numero de reducciones almacenadas en la base de datos
    def get_numReduccionesBD(self):
        return self._numReduccionesBD

    # Para actualizar el valor 
    def actualizar_numReduccionesBD(self):
        self._numReduccionesBD = self._base_datos.get_tabla_simulador().get_numSimulaciones_enBD()
    
    
    # Funcion que sirve para 'borrar' la BD
    def limpiar_bd(self):
        self._numReduccionesBD = 0
    ...
    # Informacion del grafo generada durante la reduccion SAT <= HAMPTH

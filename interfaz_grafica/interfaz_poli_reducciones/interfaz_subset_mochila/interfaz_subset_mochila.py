...
# SUBSET-SUM -> MOCHILA.
######################################################################
class InterfazSubsetMochila(InterfazPoliReduccion):
    ...
    # Método que contiene la poli-reducción de SUBSET-SUM a MOCHILA.
    def lanzar_interfaz_poli_reduccion(self, lista_resultados_previos):
        ...
        ventana_poli_reduccion.iconbitmap('interfaz_grafica/interfaz_app/img/simulador.ico')
        ventana_poli_reduccion.title("Poli-reducción de SUBSET a MOCHILA. MOCHILA es NP-Completo")

        gestor_etapas = GestorEtapas(ventana_poli_reduccion, [])

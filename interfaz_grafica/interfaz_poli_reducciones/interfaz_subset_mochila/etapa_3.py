...
# que MOCHILA es NP-Completo. Esto se debe a la aplicación del 
...
class Etapa3(Etapa):
    ...
    def lanzar_etapa(self):
        ...
        label = ctk.CTkLabel(panel_subtitulo, text="MOCHILA es NP-Completo", fg_color="#A4B6CD",
        ...
        texto = "En nuestro caso, aplicamos el teorema con L = SUBSET-SUM (ya sabemos que es \nNP-Completo) " \
        "y L'= MOCHILA, así que concluimos que MOCHILA es NP-Completo."
        ...
        boton_siguiente = ctk.CTkButton(panel_botones_3, text="Fin",command=lambda:self.gestor_etapas.siguiente(4))

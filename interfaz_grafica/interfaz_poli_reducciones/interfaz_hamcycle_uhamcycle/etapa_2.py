...
# que UHAMCYCLE es NP-Completo. Esto se debe a la aplicación del 
...
class Etapa2(Etapa):
    ...
    def lanzar_etapa(self):
        ...
        label = ctk.CTkLabel(panel_subtitulo, text="UHAMCYCLE es NP-Completo", fg_color="#A4B6CD",
        ...
        texto = "En nuestro caso, aplicamos el teorema con L = HAMCYCLE (ya sabemos que \nes NP-Completo) " \
        "y L'= UHAMCYCLE, así que concluimos que UHAMCYCLE es \nNP-Completo."

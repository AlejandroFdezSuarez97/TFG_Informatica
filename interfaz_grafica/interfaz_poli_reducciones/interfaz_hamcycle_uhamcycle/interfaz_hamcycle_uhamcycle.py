...
# HAMCYCLE -> UHAMCYCLE.
######################################################################
class InterfazhamcycleUhamcycle(InterfazPoliReduccion):
    ...
    # Método que contiene la poli-reducción de HAMCYCLE a UHAMCYCLE.
    def lanzar_interfaz_poli_reduccion(self, lista_resultados_previos):
        ...
        ventana_poli_reduccion.title("Poli-reducción de HAMCYCLE a UHAMCYCLE. UHAMCYCLE es NP-Completo")
